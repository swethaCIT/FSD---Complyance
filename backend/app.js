...
// Serve static when running standalone; on Vercel we use vercel.json routes
...
const time_saved_per_invoice = 8; // minutes (not directly used)
...
function simulate(inputsRaw) {
  const inputs = {
    ...
    error_rate_manual: toNumber(inputsRaw.error_rate_manual) / 100,
